<?php $links = get_field('nav', 'option'); ?>
        ...
        <div class="mobile-nav__links">
            <?php foreach($links as $item){
                ...
                $button = $item['button'];
                    ...
                    ?>
                        <?php if(!$button){ ?>
                        <a class="mobile-nav__link <?= $active_class; ?>" href="<?php echo esc_url( $link_url ); ?>" target="<?php echo esc_attr( $link_target ); ?>"><?php echo esc_html( $link_title ); ?></a>
                        <?php } 
                        else {
                        ?>
